...
static constexpr double DROP_ZONE_TURN_OMEGA_RPS = 1.5;   // turn speed (positive = right)
static constexpr double DROP_ZONE_TURN_TIME_S    = 0.35;  // 30deg @ 1.5 rad/s ≈ 0.35s
static constexpr double DROP_ZONE_DRIVE_SPEED_MPS = 0.15;
...
static constexpr double FIND_LINE_REVERSE_TIME_S = 0.6;      // reverse to clear dropped package
