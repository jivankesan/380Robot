...
static constexpr double KD_LATERAL = 10.0;
static constexpr double KP_HEADING = 0;
static constexpr double KD_HEADING = 0;  // raised from 8.0 – anticipate turn earlier
...
static constexpr double HEADING_BRAKE_GAIN = 5.0;  // raised from 3.5 – brake harder into turns
static constexpr double TURN_SPEED_GAIN = 8.0;
static constexpr double MIN_TURN_SPEED_MPS = 0.2;  // raised from 0.12 – from run 4094
static constexpr double TURN_OMEGA_DEADBAND = 0.00;
...
static constexpr double SP_A_MAX_DECEL = 12.0;  // raised from 8.0 – brake faster into turns
