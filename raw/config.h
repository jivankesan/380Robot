...
static constexpr double MIN_TURN_SPEED_MPS = 0.08;
...
static constexpr double SP_V_MIN = 0.08;
...
static constexpr double SP_K_HEADING = 0.76;    // scaled up with SP_V_MAX to keep same turn speed
