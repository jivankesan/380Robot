...
static constexpr double BASE_SPEED_MPS = 1.02;   // was 1.056 – slight pullback from overshoot
...
static constexpr double HEADING_BRAKE_GAIN = 1.2;  // was 1.0 – restore some heading braking
