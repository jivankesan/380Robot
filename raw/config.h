...
static constexpr double BASE_SPEED_MPS = 0.65;     // was 0.50  – faster on straights
...
static constexpr double HEADING_BRAKE_GAIN = 2.5;  // was 2.0  – absorbs +0.15 m/s BASE delta in turns
static constexpr double TURN_SPEED_GAIN = 6.0;     // was 5.0  – absorbs +0.15 m/s BASE delta in turns
